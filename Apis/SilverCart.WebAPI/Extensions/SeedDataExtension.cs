...
using RoleEnum = SilverCart.Domain.Enums.RoleEnum;
    ...
    public static class SeedDataExtension
    {
        ...
        private static async Task AddStoreAndProducts(AppDbContext dbContext)
        {
            ...
            try
            {
                ...
                var customerFaker = new Faker<CustomerUser>("vi")
                    ...
                    .RuleFor(c => c.Rank, f => new CustomerRank { Rank = RankEnum.Bronze });
                ...
                dbContext.CustomerUsers.AddRange(customers);
                await dbContext.SaveChangesAsync();

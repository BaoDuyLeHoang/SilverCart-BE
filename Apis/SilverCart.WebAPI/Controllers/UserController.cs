...
using Infrastructures;
using Infrastructures.Features.Users.Queries.GetAllUsers;
using Infrastructures.Features.Users.Queries.GetConsultantUser;
...
namespace WebAPI.Controllers
{
    ...
    public class UserController(IMediator mediator) : BaseController
    {
        ...
        public async Task<ActionResult<List<Infrastructures.Features.Users.Queries.GetAllUsers.GetGuardianUserResponse>>> GetGuardianUsers(
        ...
        public async Task<IActionResult> GetCustomerUser([FromQuery] GetCustomerUserQuery request)
        {
            var result = await _mediator.Send(request);
            return Ok(result);
        }
        [HttpGet("consultant-users")]
        public async Task<IActionResult> GetConsultantUser([FromQuery] GetConsultantUserQuery request)
        {
            var result = await _mediator.Send(request);
            return Ok(result);
        }

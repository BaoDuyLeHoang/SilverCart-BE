...
namespace WebAPI.Services
{
    public class ClaimsService : IClaimsService
    {
        ...
        public bool IsCustomer =>
            CurrentRole == RoleEnum.Guardian || CurrentRole == RoleEnum.DependentUser;
        public bool IsStoreOwner =>
            CurrentRole == RoleEnum.ShopOwner || CurrentRole == RoleEnum.Admin;
        public bool IsAdmin => CurrentRole == RoleEnum.Admin;
        public bool IsConsultant => CurrentRole == RoleEnum.Consultant;
        public bool IsSuperAdmin => CurrentRole == RoleEnum.SuperAdmin;
    }
}
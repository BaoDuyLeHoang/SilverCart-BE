...
public record GetAllOrdersResponse(Guid Id, double TotalPrice, DateTime? CreatedDate, string OrderStatus, string Address, List<GetAllOrderDetailsResponse> OrderDetails);

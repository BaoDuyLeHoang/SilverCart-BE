...
public record CreateOrderResponse(Guid Id, decimal TotalPrice, OrderStatusEnums OrderStatus, DateTime CreatedDate, List<CreateOrderDetailResponse> OrderDetails);

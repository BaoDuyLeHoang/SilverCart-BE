...
{
    public sealed record ChangeOrderItemsStatusToShipCommand(Guid OrderId, Guid StoreOrderId, Guid StoreProductItemOrderId, int ServiceTypeId, int PaymentTypeId, RequireNoteEnums RequireNote) : IRequest<ChangeOrderItemsStatusToShipResponse>;

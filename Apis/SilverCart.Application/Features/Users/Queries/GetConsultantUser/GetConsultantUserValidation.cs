...
{
    public class GetConsultantUserValidation : AbstractValidator<GetConsultantUserQuery>
    {
        public GetConsultantUserValidation()
        {
            ...
            {
                RuleFor(x => x.Phone)
                    .MaximumLength(11).WithMessage("Số điện thoại tìm kiếm không được vượt quá 11 ký tự")

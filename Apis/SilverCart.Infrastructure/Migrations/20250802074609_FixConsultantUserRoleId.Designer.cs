...
namespace Infrastructures.Migrations
{
    ...
    [Migration("20250802074609_FixConsultantUserRoleId")]
    partial class FixConsultantUserRoleId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Auth.ConsultantRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c66a403b-e1f9-47f3-9f6b-d8c3913b7a19"),
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Carts.Cart", b =>
                {
                    b.HasBaseType("SilverCart.Domain.Entities.BaseEntity");
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Carts.CartItem", b =>
                {
                    b.HasBaseType("SilverCart.Domain.Entities.BaseEntity");
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Payments.CustomerPaymentMethod", b =>
                {
                    b.HasBaseType("SilverCart.Domain.Entities.BaseEntity");
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Promotions.UserPromotion", b =>
                {
                    b.HasBaseType("SilverCart.Domain.Entities.BaseEntity");
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Auth.ConsultantUser", b =>
                {
                    ...
                    b.Property<Guid?>("ConsultantRoleId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Auth.DependentUser", b =>
                {
                    b.HasBaseType("SilverCart.Domain.Entities.Auth.CustomerUser");
                    ...
                    b.Property<List<int>>("SuggestedCategoryIds")
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Orders.OrderPaymentStatus", b =>
                {
                    ...
                    b.HasOne("SilverCart.Domain.Entities.BaseUser", "PaidUser")
                        .WithMany()
                        .HasForeignKey("PaidUserId");

                    b.Navigation("PaidUser");
                });
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Auth.ConsultantRole", b =>
                {
                    b.HasOne("SilverCart.Domain.Commons.Entities.BaseRole", null)
                        .WithOne()
                        .HasForeignKey("SilverCart.Domain.Entities.Auth.ConsultantRole", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Auth.Wallet", b =>
                {
                    ...
                    b.HasOne("SilverCart.Domain.Entities.BaseUser", "User")
                        .WithOne()
                        .HasForeignKey("SilverCart.Domain.Entities.Auth.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Carts.Cart", b =>
                {
                    b.HasOne("SilverCart.Domain.Entities.Auth.ConsultantUser", "Consultant")
                        .WithMany()
                    ...
                    b.HasOne("SilverCart.Domain.Entities.BaseEntity", null)
                        .WithOne()
                        .HasForeignKey("SilverCart.Domain.Entities.Carts.Cart", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Carts.CartItem", b =>
                {
                    b.HasOne("SilverCart.Domain.Entities.Carts.Cart", "Cart")
                        .WithMany("CartItems")
                    ...
                    b.HasOne("SilverCart.Domain.Entities.BaseEntity", null)
                        .WithOne()
                        .HasForeignKey("SilverCart.Domain.Entities.Carts.CartItem", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("SilverCart.Domain.Entities.Auth.CustomerUser", "RecieveUser")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Payments.CustomerPaymentMethod", b =>
                {
                    b.HasOne("SilverCart.Domain.Entities.Auth.DependentUser", "Customer")
                    ...
                    b.HasOne("SilverCart.Domain.Entities.BaseEntity", null)
                        .WithOne()
                        .HasForeignKey("SilverCart.Domain.Entities.Payments.CustomerPaymentMethod", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Promotions.UserPromotion", b =>
                {
                    ...
                    b.HasOne("SilverCart.Domain.Entities.BaseEntity", null)
                        .WithOne()
                        .HasForeignKey("SilverCart.Domain.Entities.Promotions.UserPromotion", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.Auth.ConsultantUser", b =>
                {
                    b.HasOne("SilverCart.Domain.Entities.Auth.ConsultantRole", "ConsultantRole")
                        .WithMany("Customers")

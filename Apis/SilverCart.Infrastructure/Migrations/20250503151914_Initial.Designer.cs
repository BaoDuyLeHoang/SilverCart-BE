...
namespace Infrastructures.Migrations
{
    ...
    [Migration("20250503151914_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.BaseEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("6257c3dc-b67d-45c5-84fb-cf10a3513734"))
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.BaseRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.AdministratorRole", b =>
                {
                    b.HasBaseType("SilverCart.Domain.Entities.BaseRole");
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.CustomerUser", b =>
                {
                    b.HasBaseType("SilverCart.Domain.Entities.BaseUser");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("SilverCart.Domain.Entities.BaseRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.CustomerAddress", b =>
                {
                    ...
                    b.HasOne("SilverCart.Domain.Entities.CustomerUser", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.UserPromotion", b =>
                {
                    ...
                    b.HasOne("SilverCart.Domain.Entities.CustomerUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SilverCart.Domain.Entities.CustomerUser", b =>
                {
                    b.HasOne("SilverCart.Domain.Entities.BaseUser", null)
                        .WithOne()
                        .HasForeignKey("SilverCart.Domain.Entities.CustomerUser", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
